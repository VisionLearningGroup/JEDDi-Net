...
class SolverWrapper(object):
    ...
    def __init__(self, solver_prototxt, roidb, output_dir,
                 pretrained_model=None, detection_pretrained_model=None):
        ...
        if detection_pretrained_model is not None:
            print ('Loading detection pretrained model '
                   'weights from {:s}').format(detection_pretrained_model)
            self.solver.net.copy_from(detection_pretrained_model)
...
def get_training_roidb(imdb):      # no use for this func
...
def filter_roidb(roidb):  #no use for this function
